...
DATA1="/users/ebrown62/scCODA/sccoda/datasets/scCODA_simulated_N=200_K=5_P=1000_SEED=0.csv"
DATA2="/users/ebrown62/scCODA/sccoda/datasets/scCODA_simulated_N=200_K=5_P=5000_SEED=0.csv"

python /users/ebrown62/scCODA/sccoda/datasets/hmc_tuner.py "$DATA1" "$DATA2"
